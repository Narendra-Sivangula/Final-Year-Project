...
public class Steganograph
{
	...
	public static boolean embedMessage(File masterFile, File outputFile, String msg, int compression, String password)
	{
		...
		message= " Data Encrypted Sucsessfully and Message embedded successfully in file '"+ outputFile.getName()+ "'.";
		return true;
	}
	//  **********************************************************************************************************************
   ...
   //  *********************************************************************************************************************
	...
	private static class AboutFrame extends JFrame implements ActionListener
	{
		...
		public AboutFrame()
		{
			...
			lblName= new MyJLabel("Batch - 05", new Font("Monotype Corsiva", Font.PLAIN, 14), GREEN, BLACK);
			lblEmail= new MyJLabel(" Batch - 05", GREEN, BLACK);
			lblPhone= new MyJLabel("Batch - 05", GREEN, BLACK);
