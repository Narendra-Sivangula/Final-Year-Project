...
public class MainClient extends WindowAdapter implements ActionListener
{
	...
	private MainClient()
	{
		mainFrame= new JFrame("Towards Robust Image Steganography");
		...
		Font arialFont= new Font("Arial", Font.PLAIN, 50);          // 14
		Font myFont= new Font("Monotype Corsiva", Font.PLAIN, 50);     // 18
		
		// Prepare the Buttons panel
		panelButtons.setBackground(Color.lightGray);
		gbl= new GridBagLayout();
		panelButtons.setLayout(gbl);
		panelButtons.setBorder(new TitledBorder("Embedding And Retreiving Functions"));
		
		
        lblLogo= new JLabel(new ImageIcon("./Images/Project Logo.png"));
